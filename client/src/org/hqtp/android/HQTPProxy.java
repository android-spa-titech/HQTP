...
public class HQTPProxy {
    ...
    private HttpResponse sendByGet(String path) throws ClientProtocolException, IOException
    {
...
//テスト
    ...
    private static String getResponseContentText(HttpResponse response) throws IllegalStateException, IOException
    {
